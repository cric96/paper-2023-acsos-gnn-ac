...
\begin{figure}
  \centering
  \includegraphics[width=0.3\textwidth]{imgs/start.png}
  \label{fig:example}
...
To test the effectiveness of the proposed approach, 
 ...
 Initially, 
  ...
  Figure~\ref{fig:example} illustrates a set of 25 agents and a single, stationary phenomenon with a 3D Gaussian distribution.''
