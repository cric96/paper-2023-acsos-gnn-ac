...
impacted by the challenges posed by the very notion of distributed intelligence,
 that concern in achieving a common, global goal of acquiring information locally, sharing their knowledge, and acting accordingly in their environment. 
%
The problem is even more evident in large-scale collective adaptive systems, 
where agent interactions are necessarily proximity-based, thus making the emergence of controlled global collective behaviour harder, since the individual agents need to control how they share their knowledge in order to not overburden the network or other agents with unnecessary information. %\lukas{what does it make harder?}
...
%}
Since we consider swarm-like systems, that are an example of many-agent systems, 
 the proposed approach follows a \ac{CDTE} learning pattern,
