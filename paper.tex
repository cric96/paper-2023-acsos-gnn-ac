...
\begin{document}
%
\title{Field-informed Reinforcement Learning Collective Tasks with Graph Neural Networks} %% Todo improve
...
Moreover, the learned policies have the potential to scale to different network topologies due to the inherent nature of GNNs and aggregate computations.
