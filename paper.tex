...
In this paper, we consider a new \emph{hybrid} approach called  \emph{Field-Informed reinforcement learning}, 
  which uses manually designed \emph{computational fields} (globally distributed data structures) to manage the interaction between agents 
  and \emph{Graph Neural Networks} to learn the local behaviour necessary to solve collective tasks. 
%
