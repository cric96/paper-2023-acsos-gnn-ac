...
Initially, 
  ...
  Finally, the phenomenon may have varying areas of interest, defined by an underlying distribution function. \lukas{are we utiliising this in any way? i.e. do the agents respond to intensity of their measurement.}
...
%
\lukas{should the following go into section III?}
...
\lukas{I would move this up into IV.A}
