...
%
Specifically, we consider systems of \emph{devices} (or nodes) equipped with \emph{sensors} and \emph{actuator}
...
Given the homogeneity and large scale considered and the \emph{locality} (i,e., each agent can only observe its neighbours), 
 ...
 an extension of the \ac{DecPOMDP}~\cite{Decpomdp2000} model to swarm-like systems. \ga{todo: define swarm-like systems}
% 
...
Compared to earlier works, 
 our approach builds on the concept of co-fields, 
