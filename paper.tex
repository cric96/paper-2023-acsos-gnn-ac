...
\begin{abstract}
Coordinating a group of autonomous intelligent agents in multi-agent systems to achieve a common, global goal requires them to acquire information locally, share their knowledge, and act accordingly on their environment. This shared knowledge leads to distributed intelligence, enabling the collective of agents to operate together.
With the rising number of such autonomous agents within these systems, sharing knowledge becomes a dedicated challenge. Here, the individual agents need to control how they share their knowledge in order to not overburden the network or other agents with unnecessary information.
...
% 
Thus far, two main approaches have been proposed for creating such distributed controllers: 
...
In this paper, we consider a new \emph{hybrid} approach called  \emph{Field-Informed reinforcement learning}, 
  ...
  and \emph{Graph Neural Networks} to learn a local behaviour necessary to solve collective tasks.
   \lukas{are you considering computational fields as `manual design'} 
%
