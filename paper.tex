...
%
Examples of CPSs include swarm robotics~\cite{brambilla2013swarm}, smart cities~\cite{bajovic2021marvel}, sensor networks~\cite{pianini2022collective}, and social systems. 
...
We employ this approach in a swarm-like system setting where agents are tasked to cover phenomena detected in their environment. Over time, the agents have to converge over the each phenomenon in order to cover it appropriately as illustrated in \Cref{fig:simulations}.
\begin{figure}[t]
	\centering
...
\begin{figure}
  ...
  Using this feature, an aggregate program computes spatio-temporal information that enhances the feature set of each agent, depicted as colours in the middle graph. 
